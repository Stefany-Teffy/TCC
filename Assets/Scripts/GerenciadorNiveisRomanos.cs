...
public class GerenciadorNiveisRomanos : MonoBehaviour
{
    ...
    private GerenciadorEstrelasRomanos gerenciadorEstrelas;

    void Start()
    {
        gerenciadorEstrelas = FindObjectOfType<GerenciadorEstrelasRomanos>();
    }
